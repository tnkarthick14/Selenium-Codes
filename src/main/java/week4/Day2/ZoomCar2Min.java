...
public class ZoomCar2Min {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		int frequency1 = Collections.frequency(ls, min);
		System.out.println("Min Price Occurance  :" + frequency1);
		System.out.println("Min price :" + min);
		for (int i=frequency1;i>=1;i--)
		{
		WebElement Element2 = driver.findElementByXPath("(//div[contains(text(),'"+min+"')])["+i+"]/../../preceding-sibling::div/h3");
		String Brand = Element2.getText();
		System.out.println("Brand Name : " + Brand);
		}
		
		driver.findElementByXPath("((//div[contains(text(),'"+min+"')])[1]/following::button)[1]").click();
		Thread.sleep(2000);
