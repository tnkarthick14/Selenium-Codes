...
public class FixMyBugs2 {

	@Test
	public void myBugs() throws InterruptedException {
		...
		builder.moveToElement(driver.findElementByXPath("(//a[@href='/men-jackets'])[1]")).click();
		// Click on Jackets
		//driver.findElementByXPath("(//a[@href='/men-jackets'])[1]").click();
